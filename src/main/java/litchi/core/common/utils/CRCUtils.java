...
public class CRCUtils {
    ...
    /**
     * Parameters represents set of args defining a particular CRC algorithm.
     */
    public static class Parameters {
        ...
        /**
         * Castagnoli polynomial. used in iSCSI. And also provided by calcHash/crc32 package.
         */
        ...
        /**
         * CRC64ISO is set of args commonly known as CRC64-ISO
         */
        ...
        /**
         * CRC64ECMA is set of args commonly known as CRC64-ECMA
         */
     ...
     *
     * @param crcParams CRC algorithm args
     * @param data      data for the CRC calculation
     * @return the CRC value of the data provided
     */
    public static long calculateCRC(Parameters crcParams, byte[] data, int startIndex, int endIndex) {
    ...
    public static long calculateCRC(String text) {
        return calculateCRC(Parameters.CRC32, text.getBytes());
    }
